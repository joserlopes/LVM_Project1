...
# secret code = [8, 0, 1, 9, 5, 8, 0, 0, 2]
[
    [1, 0, 6, 8, 1, 6, 5, 7, 3], 1, 3,
    [6, 0, 2, 4, 3, 7, 6, 3, 3], 1, 1,
    [7, 2, 4, 8, 2, 0, 8, 5, 7], 0, 5,
    [1, 5, 5, 4, 5, 5, 2, 9, 1], 1, 3,
    [6, 4, 1, 7, 1, 5, 9, 5, 3], 1, 2,
    [6, 6, 8, 2, 5, 5, 2, 5, 6], 1, 2,
    [8, 1, 3, 6, 4, 1, 1, 0, 2], 3, 1,
    [9, 3, 6, 3, 7, 4, 9, 6, 6], 0, 1,
    [7, 6, 8, 2, 9, 1, 9, 7, 8], 0, 5,
    [7, 1, 2, 1, 7, 3, 0, 0, 0], 2, 3,
    [8, 4, 8, 4, 0, 9, 8, 7, 5], 1, 4,
    [1, 1, 0, 1, 7, 3, 2, 0, 0], 1, 4,
    [0, 7, 1, 3, 3, 4, 7, 3, 0], 1, 2,
    [2, 3, 7, 8, 9, 1, 6, 9, 3], 0, 4,
    [7, 8, 3, 3, 3, 2, 0, 4, 6], 1, 2,
    [4, 3, 5, 6, 0, 6, 1, 7, 8], 0, 4,
    [1, 3, 0, 7, 2, 8, 4, 6, 2], 2, 2,
    [4, 6, 1, 1, 4, 0, 6, 7, 1], 1, 1,
    [2, 0, 5, 4, 1, 4, 7, 9, 1], 1, 4,
    [0, 2, 6, 8, 4, 3, 5, 6, 5], 0, 4,
],
